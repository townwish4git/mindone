...
from ....transformers.models.clip.modeling_ms_clip import CLIPTextModelWithProjection
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        data_type = mindspore.float16
        prior = PriorTransformer.from_pretrained(prior_model_id, subfolder="prior", mindspore_dtype=data_type, use_safetensors=True)

        prior_text_model_id = "openai/clip-vit-large-patch14"
        prior_tokenizer = CLIPTokenizer.from_pretrained(prior_text_model_id, use_safetensors=True)
        prior_text_model = CLIPTextModelWithProjection.from_pretrained(prior_text_model_id, mindspore_dtype=data_type, use_safetensors=True)
