...
class DDPMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        # See formula (7) from https://arxiv.org/pdf/2006.11239.pdf
        pred_prev_sample = pred_original_sample_coeff.to(dtype) * pred_original_sample + current_sample_coeff.to(dtype) * sample
        ...
        if t > 0:
            ...
            if self.variance_type == "fixed_small_log":
                ...
                variance = (self._get_variance(t, predicted_variance=predicted_variance) ** 0.5).to(dtype) * variance_noise
