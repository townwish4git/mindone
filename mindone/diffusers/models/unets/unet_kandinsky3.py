...
class Kandinsky3UpSampleBlock(nn.Cell):
    def __init__(
        self,
        in_channels,
        cat_dim,
        ...
        self.resnets_in = nn.CellList(resnets_in)
        self.resnets_out = nn.CellList(resnets_out)
...
class Kandinsky3DownSampleBlock(nn.Cell):
    def __init__(
        self,
        in_channels,
        out_channels,
...
class Kandinsky3ResNetBlock(nn.Cell):
    def __init__(
        ...
        self.resnet_blocks = nn.CellList(
            [
...
class Kandinsky3AttentionPooling(nn.Cell):
