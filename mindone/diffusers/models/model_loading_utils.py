...
def load_checkpoint_and_dispatch(
    ...
    for checkpoint_file in checkpoint_files:
        ...
        param_not_load, ckpt_not_load = ms.load_param_into_net(model, loaded_checkpoint, strict_load=strict)
        unexpected_keys.update(set(ckpt_not_load))
...
def split_torch_state_dict_into_shards(
    ...
    *,
    ...
    return split_state_dict_into_shards_factory(
        ...
        # get_storage_id=get_torch_storage_id,  // comment this line as mindspore has no Tensor.data_ptr()
    )
