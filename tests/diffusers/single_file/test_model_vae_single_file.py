...
class TestAutoencoderKLSingleFile:
    ...
    def get_sd_image(self, seed=0, shape=(4, 3, 512, 512), fp16=False):
        ...
        image = ms.Tensor.from_numpy(load_hf_numpy(self.get_file_format(seed, shape))).to(dtype)
        return image
    ...
    def test_single_file_inference_same_as_pretrained(self):
        ...
        output_slice_1 = sample_1.flatten().float()
        output_slice_2 = sample_2.flatten().float()
