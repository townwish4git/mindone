...
from mindone.diffusers import ControlNetModel, StableDiffusionControlNetInpaintPipeline
...
class TestStableDiffusionControlNetInpaintPipelineSingleFileSlow(SDSingleFileTesterMixin):
    ...
    def get_inputs(self):
        ...
        image = load_image("https://huggingface.co/lllyasviel/sd-controlnet-canny/resolve/main/images/bird.png").resize(
            (512, 512)
        )
