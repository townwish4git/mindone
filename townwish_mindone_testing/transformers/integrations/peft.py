...
from transformers.utils import find_adapter_config_file, logging
...
class PeftAdapterMixin:
    ...
    def load_adapter(
        ...
        adapter_state_dict: Optional[Dict[str, "ms.Tensor"]] = None,
        ...
        from townwish_mindone_testing.diffusers._peft import PeftConfig, inject_adapter_in_model, load_peft_weights
        from townwish_mindone_testing.diffusers._peft.utils import set_peft_model_state_dict
    ...
    def add_adapter(self, adapter_config, adapter_name: Optional[str] = None) -> None:
        ...
        """
        from townwish_mindone_testing.diffusers._peft import PeftConfig, inject_adapter_in_model
        ...
        # but to be consistent with what we do in PEFT:
        # https://github.com/huggingface/peft/blob/6e783780ca9df3a623992cc4d1d665001232eae0/src/peft/mapping.py#L100
    ...
    def set_adapter(self, adapter_name: Union[List[str], str]) -> None:
        ...
        from townwish_mindone_testing.diffusers._peft.utils import ModulesToSaveWrapper
    ...
    def get_adapter_state_dict(self, adapter_name: Optional[str] = None) -> dict:
        ...
        from townwish_mindone_testing.diffusers._peft import get_peft_model_state_dict
