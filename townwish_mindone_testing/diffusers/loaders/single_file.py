...
if is_transformers_available():
    ...
    from townwish_mindone_testing.transformers import MSPreTrainedModel as PreTrainedModel
...
def load_single_file_sub_model(
    ...
    **kwargs,
    ...
    if is_diffusers_single_file_model:
        ...
        # Schedulers and Tokenizers don't make use of mindspore_dtype
        # Skip passing it to those objects
        if issubclass(class_obj, nn.Cell):
            loading_kwargs.update({"mindspore_dtype": mindspore_dtype})
...
def _map_component_types_to_config_dict(component_types):
    ...
    for component_name, component_value in component_types.items():
        ...
        is_transformers_model = is_transformers_available() and issubclass(component_value[0], PreTrainedModel)
...
class FromSingleFileMixin:
    ...
    def from_single_file(cls, pretrained_model_link_or_path, **kwargs):
        ...
        from townwish_mindone_testing.diffusers import pipelines
