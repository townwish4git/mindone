...
from townwish_mindone_testing.safetensors.mindspore import load_file
...
def load_textual_inversion_state_dicts(pretrained_model_name_or_paths, **kwargs):
    ...
    for pretrained_model_name_or_path in pretrained_model_name_or_paths:
        if not isinstance(pretrained_model_name_or_path, (dict, mindspore.Tensor)):
            ...
            if model_file is None:
                ...
                state_dict = mindspore.load_checkpoint(model_file)
        else:
