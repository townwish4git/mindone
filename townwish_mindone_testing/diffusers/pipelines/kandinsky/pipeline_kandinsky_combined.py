...
from townwish_mindone_testing.transformers import CLIPTextModelWithProjection, CLIPVisionModelWithProjection
...
IMAGE2IMAGE_EXAMPLE_DOC_STRING = """
    Examples:
        ...
        pipe = KandinskyImg2ImgCombinedPipeline.from_pretrained(
            "kandinsky-community/kandinsky-2-1", mindspore_dtype=ms.float16
        )
...
INPAINT_EXAMPLE_DOC_STRING = """
    Examples:
        ...
        pipe = KandinskyInpaintCombinedPipeline.from_pretrained(
