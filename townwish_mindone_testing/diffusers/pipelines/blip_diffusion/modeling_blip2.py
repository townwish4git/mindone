...
from townwish_mindone_testing.transformers.activations import QuickGELUActivation as QuickGELU
from townwish_mindone_testing.transformers.modeling_outputs import (
    BaseModelOutputWithPastAndCrossAttentions,
    BaseModelOutputWithPooling,
    BaseModelOutputWithPoolingAndCrossAttentions,
)
from townwish_mindone_testing.transformers.models.blip_2.modeling_blip_2 import (
    Blip2Encoder,
...
# There is an implementation of Blip2 in `transformers` :
...
class Blip2QFormerModel(Blip2PreTrainedModel):
    ...
    def __init__(self, config: Blip2Config):
        ...
        self.num_hidden_layers = config.qformer_config.num_hidden_layers
