...
from townwish_mindone_testing.transformers import CLIPVisionModelWithProjection
    ...
    def __call__(
        ...
        Returns:
            [`~pipelines.stable_diffusion.StableDiffusionPipelineOutput`] or `tuple`:
                If `return_dict` is `False`, [`~pipelines.stable_diffusion.StableDiffusionPipelineOutput`] is returned,
