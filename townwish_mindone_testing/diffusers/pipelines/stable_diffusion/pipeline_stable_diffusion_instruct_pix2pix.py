...
class StableDiffusionInstructPix2PixPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Args:
            ...
            image (`ms.Tensor` `np.ndarray`, `PIL.Image.Image`, `List[ms.Tensor]`, `List[PIL.Image.Image]`, or `List[np.ndarray]`):
    ...
    def prepare_image_latents(self, image, batch_size, num_images_per_prompt, dtype, do_classifier_free_guidance):
