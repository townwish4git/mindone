...
# Adaptied from diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_img2img.retrieve_latents
...
class LatentConsistencyModelImg2ImgPipeline(DiffusionPipeline, StableDiffusionMixin, LoraLoaderMixin):
    r"""
