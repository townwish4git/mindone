...
By default, SDXL uses DDPM for training by default. It can be changed to the EDM-style training by configuring the `denoiser` and other related parameters of the training. 
