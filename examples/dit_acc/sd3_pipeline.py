...
class StableDiffusion3PipelineBoost(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    ...
    def _enable_boost(self, use_cache_and_tgate: bool = True, use_todo: bool = False):
        ...
        self.use_cache_and_tgate = (
            use_cache_and_tgate if self.use_cache_and_tgate != use_cache_and_tgate else self.use_cache_and_tgate
        )
        if use_cache_and_tgate and not use_todo:
            self.transformer.phase = "cache_tgate"
        elif not use_cache_and_tgate and use_todo:
            self.transformer.phase = "todo"
        elif use_cache_and_tgate and use_todo:
            self.transformer.phase = "cache_tgate_todo"
        else:
